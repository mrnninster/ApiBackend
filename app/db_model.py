...
class Orders(db.Model):
    ...
    order_user_id = Column(String(255),unique=True,index=True)
    order_vendor_id = Column(String(255),unique=True,index=True)
    order_product_id = Column(String(255),unique=True,index=True)
    order_product_name = Column(String(255),unique=True,index=True)
    order_product_price = Column(String(255),unique=True,index=True)
    order_product_discount = Column(String(255),unique=True,index=True)
    order_product_quantity = Column(String(255),unique=True,index=True)
    order_product_total_price = Column(String(255),unique=True,index=True)
    order_product_image = Column(String(255),unique=True,index=True)
    order_product_description = Column(String(255),unique=True,index=True)
